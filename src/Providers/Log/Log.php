...
use Monolog\Formatter\{FormatterInterface, LineFormatter};
...
class Log implements LoggerInterface
{
    ...
    protected function resolve(string $name)
    {
        ...
        if (is_null($config)) {
            throw new InvalidArgumentException(\sprintf('INVALID ARGUMENT: Log [%s] is not defined.', $name));
        }
    ...
    {
        return new Logger('foundation', $this->prepareHandlers([
            new StreamHandler(\sys_get_temp_dir() . '/logs/sevfoundation.log', $this->level(['level' => 'debug']))
        ]));
    }
    ...
    protected function level(array $config)
    {
        ...
        throw new InvalidArgumentException('INVALID ARGUMENT: Invalid log level.');
    }
